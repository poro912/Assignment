...
## 코드리뷰 및 피드백
1. 문서의 구성이 복잡하여 사용하기 보기 쉽지 않다.
2. 코드의 들여쓰기 방법이 보기 불편하다.
	* (Visual Studio와 gitHub의 뷰어 차이로 인한 가독성 저하)
3. 테이블을 이용할 것
	* 예제코드의 반복되는 문장에 테이블을 사용해 구성할 것
4. 변수 선언 형태를 한가지로 통일 할 것
5. 중괄호는 문장 뒤에쓰는 편
6. 구조체와 클래스 운용에 대해 고심해볼것
7. 선언부의 함수와 함수간에 간격을 줄 것